...
const ALL_INTRINSICS: &[Intrinsic] = &[
    ...
    Intrinsic::Tui(TuiIntrinsic::HostCreateListBoxView),
    Intrinsic::Tui(TuiIntrinsic::HostSetListBoxItems),
    Intrinsic::Tui(TuiIntrinsic::HostSetListBoxSelected),
    Intrinsic::Tui(TuiIntrinsic::QueryListBoxState),
    Intrinsic::Tui(TuiIntrinsic::HostCreateScrollBarView),
    Intrinsic::Tui(TuiIntrinsic::HostSetScrollBarExtents),
    Intrinsic::Tui(TuiIntrinsic::QueryScrollBarState),
    Intrinsic::Tui(TuiIntrinsic::HostCreateScrollView),
    ...
    Intrinsic::Tui(TuiIntrinsic::ApplicationShowFramedDialog),
    Intrinsic::Tui(TuiIntrinsic::HostSetFrameContentSize),
    Intrinsic::Tui(TuiIntrinsic::HostScrollFrame),
    Intrinsic::Tui(TuiIntrinsic::HostSetFrameScrollOffset),
    Intrinsic::Tui(TuiIntrinsic::QueryFrameScrollState),
    Intrinsic::Tui(TuiIntrinsic::HostCreateMemoView),
    Intrinsic::Tui(TuiIntrinsic::HostSetMemoText),
