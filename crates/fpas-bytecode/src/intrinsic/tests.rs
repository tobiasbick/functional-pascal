...
const ALL_INTRINSICS: &[Intrinsic] = &[
    ...
    Intrinsic::Str(StrIntrinsic::Map),
    Intrinsic::Str(StrIntrinsic::Filter),
    Intrinsic::Str(StrIntrinsic::Reduce),
    ...
    Intrinsic::Random(RandomIntrinsic::SetSeed),
    Intrinsic::Crypto(CryptoIntrinsic::RandomBytes),
    Intrinsic::Crypto(CryptoIntrinsic::RandomInt),
