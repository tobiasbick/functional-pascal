...
const ALL_INTRINSICS: &[Intrinsic] = &[
    ...
    Intrinsic::Tui(TuiIntrinsic::TestInjectKeyboard),
    Intrinsic::Tui(TuiIntrinsic::ButtonNew),
    Intrinsic::Tui(TuiIntrinsic::DialogAdd),
    Intrinsic::Tui(TuiIntrinsic::TestInjectCommand),
    Intrinsic::Tui(TuiIntrinsic::WindowNew),
    Intrinsic::Tui(TuiIntrinsic::WindowAdd),
    Intrinsic::Tui(TuiIntrinsic::DesktopAdd),
    Intrinsic::Tui(TuiIntrinsic::StaticTextNew),
    Intrinsic::Tui(TuiIntrinsic::ApplicationRunWithOnCommand),
    Intrinsic::Tui(TuiIntrinsic::MenuBarNew),
    Intrinsic::Tui(TuiIntrinsic::StatusLineNew),
    Intrinsic::Tui(TuiIntrinsic::CheckBoxNew),
    Intrinsic::Tui(TuiIntrinsic::InputLineNew),
    Intrinsic::Tui(TuiIntrinsic::CheckBoxChecked),
    Intrinsic::Tui(TuiIntrinsic::CheckBoxSetChecked),
    Intrinsic::Tui(TuiIntrinsic::InputLineText),
    Intrinsic::Tui(TuiIntrinsic::InputLineSetText),
    Intrinsic::Tui(TuiIntrinsic::ListBoxNew),
    Intrinsic::Tui(TuiIntrinsic::ListBoxSelection),
    Intrinsic::Tui(TuiIntrinsic::ListBoxSetItems),
    Intrinsic::Tui(TuiIntrinsic::RadioButtonNew),
    Intrinsic::Tui(TuiIntrinsic::RadioButtonSelected),
    Intrinsic::Tui(TuiIntrinsic::RadioButtonSetSelected),
    Intrinsic::Tui(TuiIntrinsic::MemoNew),
    Intrinsic::Tui(TuiIntrinsic::MemoSetText),
    Intrinsic::Tui(TuiIntrinsic::TextViewerNew),
    Intrinsic::Tui(TuiIntrinsic::TextViewerSetText),
    Intrinsic::Tui(TuiIntrinsic::StaticTextSetText),
    Intrinsic::Tui(TuiIntrinsic::ButtonSetText),
    Intrinsic::Tui(TuiIntrinsic::DialogSetTitle),
    Intrinsic::Tui(TuiIntrinsic::WindowSetTitle),
    Intrinsic::Tui(TuiIntrinsic::MenuBarSetMenus),
    Intrinsic::Tui(TuiIntrinsic::StatusLineSetItems),
    Intrinsic::Tui(TuiIntrinsic::OutlineNew),
    Intrinsic::Tui(TuiIntrinsic::OutlineHostSelection),
