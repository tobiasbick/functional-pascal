...
impl Compiler {
    pub(super) fn builtin_const_value(name: &str) -> Option<Value> {
        builtin_const_value(name)
    }
}

pub(crate) fn builtin_const_value(name: &str) -> Option<Value> {
    ...
    match name {
        ...
        _ => match short {
            ...
            "Black" | "BW40" => Some(Value::Integer(0)),
            "Blue" | "C40" => Some(Value::Integer(1)),
            "Green" | "BW80" => Some(Value::Integer(2)),
            "Cyan" | "C80" => Some(Value::Integer(3)),
            "Red" | "CO40" => Some(Value::Integer(4)),
            "Magenta" | "CO80" => Some(Value::Integer(5)),
            "Brown" => Some(Value::Integer(6)),
            "LightGray" | "Mono" => Some(Value::Integer(7)),
            "DarkGray" => Some(Value::Integer(8)),
            "LightBlue" => Some(Value::Integer(9)),
            "LightGreen" => Some(Value::Integer(10)),
            "LightCyan" => Some(Value::Integer(11)),
            "LightRed" => Some(Value::Integer(12)),
            "LightMagenta" => Some(Value::Integer(13)),
            "Yellow" => Some(Value::Integer(14)),
            "White" => Some(Value::Integer(15)),
            "Blink" => Some(Value::Integer(128)),
            "Font8x8" => Some(Value::Integer(256)),
            _ => None,
        },
    }
}
