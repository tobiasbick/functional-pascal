...
impl Compiler {
    pub(in super::super) fn compile_while_stmt(
        ...
        self.patch_continues(loop_start as u32, (line, column))?;
    ...
    pub(in super::super) fn compile_repeat_stmt(
        ...
        self.patch_continues(condition_start, (line, column))?;

        self.compile_expr(condition)?;
        self.emit(Op::JumpIfFalse(loop_start as u32), (line, column));
