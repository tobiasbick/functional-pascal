...
#[test]
fn globals_arrays_and_dictionaries_match_stack_execution() {
    assert_both_succeed(
        "\
...
#[test]
fn result_option_and_data_enum_construction_match_stack_execution() {
    assert_both_succeed(
        "\
...
#[test]
fn record_methods_properties_and_events_match_stack_execution() {
    assert_both_succeed(
        "\
...
#[test]
fn string_indexing_and_membership_match_stack_execution() {
    assert_both_succeed(
        "\
