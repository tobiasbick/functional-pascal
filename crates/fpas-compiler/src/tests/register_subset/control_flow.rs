...
#[test]
fn nested_while_repeat_for_break_and_continue_match_stack_execution() {
    assert_both_succeed(
        "\
...
#[test]
fn scalar_case_values_ranges_guards_and_else_match_stack_execution() {
    assert_both_succeed(
        "\
...
#[test]
fn mixed_numeric_comparisons_and_integer_edges_match_stack_execution() {
    assert_both_succeed(
        "\
