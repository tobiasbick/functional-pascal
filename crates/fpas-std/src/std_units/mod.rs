...
pub use units::{
    ...
    STD_UNIT_CRYPTO, STD_UNIT_DICT, STD_UNIT_ENV, STD_UNIT_FS, STD_UNIT_JSON, STD_UNIT_MATH,
    STD_UNIT_NET, STD_UNIT_OPTION, STD_UNIT_PARSE, STD_UNIT_PATH, STD_UNIT_PROC, STD_UNIT_RANDOM,
...
use symbols::{
    STD_ARGS_SYMBOLS, STD_ARRAY_SYMBOLS, STD_CONSOLE_SYMBOLS, STD_CONV_SYMBOLS, STD_CRYPTO_SYMBOLS,
    STD_DICT_SYMBOLS, STD_ENV_SYMBOLS, STD_FS_SYMBOLS, STD_JSON_SYMBOLS, STD_MATH_SYMBOLS,
    STD_NET_SYMBOLS, STD_OPTION_SYMBOLS, STD_PARSE_SYMBOLS, STD_PATH_SYMBOLS, STD_PROC_SYMBOLS,
    STD_RANDOM_SYMBOLS, STD_RESULT_SYMBOLS, STD_SERVER_SYMBOLS, STD_STR_SYMBOLS, STD_TASK_SYMBOLS,
    STD_TEST_SYMBOLS, STD_TIME_SYMBOLS, STD_TOML_SYMBOLS,
};
...
pub fn std_unit_symbols(unit: &str) -> &'static [&'static str] {
    match unit {
        ...
        STD_UNIT_CRYPTO => STD_CRYPTO_SYMBOLS,
