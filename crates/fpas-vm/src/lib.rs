...
pub use vm::{
    ...
    DebuggeeChannelState, DebuggeeInputResult, Execution, FunctionBreakpoint,
    LiveImageClassification, LiveImageReplaceResult, LiveImageUpdateClass, MAX_RECORDING_EVENTS,
