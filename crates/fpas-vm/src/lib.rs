...
pub use vm::{
    ...
    DebugExpression, DebugFrame, DebugInspectionLimits, DebugPauseHandle, DebugRunResult,
    DebugScope, DebugScopeKind, DebugSession, DebugSessionError, DebugSessionState, DebugStop,
    DebugStopReason, DebugStringMutationResult, DebugTask, DebugTaskEvent, DebugTaskEventKind,
    DebugTaskState, DebugTermination, DebugUnaryOperation, DebugVariable, Execution, Paginated,
