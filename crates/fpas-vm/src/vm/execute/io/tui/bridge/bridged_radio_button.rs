//! Turbo Vision bridge modal `RadioButton` view that mirrors selected state into the FPAS host cell.
//!
...
impl BridgedRadioButton {
    ...
    /// Copy upstream radio state into the host cell (Turbo Vision read-back path).
