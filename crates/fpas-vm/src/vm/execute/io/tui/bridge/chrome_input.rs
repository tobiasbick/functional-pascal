...
impl Worker {
    pub(in crate::vm::execute::io::tui) fn turbo_vision_set_menu_bar(
        ...
        super::bridge_set_menu_bar(self, handle, line)
    }
    ...
    pub(in crate::vm::execute::io::tui) fn turbo_vision_set_status_line(
        ...
        self.pop_tui_application(line)?;
        super::bridge_set_status_line(self, handle, line)
    }

    /// Parses menu records for Turbo Vision `MenuBar.New`.
    ...
    /// Parses status items for Turbo Vision `StatusLine.New`.
