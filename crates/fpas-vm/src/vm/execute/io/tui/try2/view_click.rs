//! Screen-space hit targets for try-2 headless `TestClickMouse`.
//!
...
pub(in crate::vm::execute::io::tui::try2) fn widget_screen_bounds(
    parent_bounds: Rect,
    local_bounds: Rect,
) -> Rect {
    Rect::new(
...
pub(in crate::vm::execute::io::tui::try2) fn widget_mouse_click_point(
    parent_bounds: Rect,
    local_bounds: Rect,
) -> Point {
...
pub(in crate::vm::execute::io::tui::try2) fn point_in_screen_bounds(
    bounds: Rect,
    x: i16,
    y: i16,
) -> bool {
