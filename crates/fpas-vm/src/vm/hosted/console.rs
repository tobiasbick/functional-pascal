    ...
    pub(super) fn execute_console_intrinsic(
        ...
        let result = match intrinsic {
            ...
            ConsoleIntrinsic::ReadEventTimeout => {
                ...
                Some(optional_event(self, event, location)?)
            }
            ...
            ConsoleIntrinsic::CrtColor => Some(console_color_record(
                self,
                console_crt_color(integer(arguments, 0, 1, self)?, location)?,
                location,
            )?),
            ConsoleIntrinsic::Ansi256Color => Some(console_color_record(
                self,
                console_ansi256_color(integer(arguments, 0, 1, self)?, location)?,
                location,
            )?),
            ConsoleIntrinsic::RgbColor => Some(console_color_record(
                self,
                console_rgb_color(
