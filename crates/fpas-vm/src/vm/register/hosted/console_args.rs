...
use crate::vm::execute::io::console_cell_records::console_cell_from_value;
use crate::vm::execute::io::console_records::console_event_record;
use crate::vm::register::VmError;
use crate::vm::register::worker::RegisterWorker;

pub(super) fn optional_event(event: Option<fpas_std::ConsoleEvent>) -> Value {
    event.map_or(Value::OptionNone, |event| {
        Value::OptionSome(Box::new(console_event_record(event)))
    })
}
