...
| 2 | pending | `docs/pascal/std/tui-app.md` — `Application.Run` prerequisites: include host widget views |
| 3 | pending | `docs/rust/parallel-vm.md` — fix `tui.rs` path, intrinsic range, test paths |
