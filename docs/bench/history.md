...
| bench | elapsed_ms | throughput |
|-------|------------|------------|
| task_spawn_wait | 630 | throughput: 158730 tasks/s |
| task_array_callbacks | 981 | throughput: 3914373 callbacks/s |

## 2026-09-04 — managed aggregate and string buffer reuse
...
| bench | elapsed_ms | throughput |
|-------|------------|------------|
| integer_loop | 6441 | throughput: 7762769 iters/s |
| global_access | 481 | throughput: 10395010 global updates/s |
| record_field_access | 1483 | throughput: 10114632 field accesses/s |
| closure_call | 467 | throughput: 6423982 closure calls/s |
| branch_dispatch | 3133 | throughput: 6383657 branches/s |
| dynamic_numeric | 846 | throughput: 5910165 dynamic numeric ops/s |
| array_push | 218 | throughput: 9174311 pushes/s |
| array_length | 73 | throughput: 6849315 lengths/s |
| string_concat | 2096 | throughput: 2385496 concats/s |
| string_length | 72 | throughput: 6944444 lengths/s |
| intrinsic_dispatch | 1771 | throughput: 8469791 intrinsic calls/s |
| function_call | 725 | throughput: 8275862 calls/s |
| array_callbacks | 981 | throughput: 9785932 callbacks/s |
| record_update | 365 | throughput: 2739726 updates/s |
| unicode_char_at | 1233 | throughput: 2433090 chars/s |
| task_spawn_wait | 517 | throughput: 193423 tasks/s |
| tui_headless | 3767 | throughput: 132 frames/s |
| notes_headless | 8079 | throughput: 30 frames/s |
...
| bench | elapsed_ms | throughput |
|-------|------------|------------|
| integer_loop | 6418 | throughput: 7790588 iters/s |
| global_access | 543 | throughput: 9208103 global updates/s |
| record_field_access | 1745 | throughput: 8595988 field accesses/s |
| closure_call | 472 | throughput: 6355932 closure calls/s |
| branch_dispatch | 3156 | throughput: 6337135 branches/s |
| dynamic_numeric | 843 | throughput: 5931198 dynamic numeric ops/s |
| array_push | 210 | throughput: 9523809 pushes/s |
| array_length | 72 | throughput: 6944444 lengths/s |
| string_concat | 2247 | throughput: 2225189 concats/s |
| string_length | 73 | throughput: 6849315 lengths/s |
| intrinsic_dispatch | 1789 | throughput: 8384572 intrinsic calls/s |
| function_call | 683 | throughput: 8784773 calls/s |
| array_callbacks | 908 | throughput: 10572687 callbacks/s |
| record_update | 445 | throughput: 2247191 updates/s |
| unicode_char_at | 1276 | throughput: 2351097 chars/s |
| task_spawn_wait | 539 | throughput: 185528 tasks/s |
| tui_headless | 4134 | throughput: 120 frames/s |
| notes_headless | 8678 | throughput: 28 frames/s |

## 2026-08-30 — after direct intrinsic routing
...
| bench | elapsed_ms | throughput |
|-------|------------|------------|
| integer_loop | 6485 | throughput: 7710100 iters/s |
| global_access | 541 | throughput: 9242144 global updates/s |
| record_field_access | 1729 | throughput: 8675534 field accesses/s |
| closure_call | 468 | throughput: 6410256 closure calls/s |
| branch_dispatch | 3101 | throughput: 6449532 branches/s |
| dynamic_numeric | 851 | throughput: 5875440 dynamic numeric ops/s |
| array_push | 211 | throughput: 9478672 pushes/s |
| array_length | 71 | throughput: 7042253 lengths/s |
| string_concat | 2234 | throughput: 2238137 concats/s |
| string_length | 72 | throughput: 6944444 lengths/s |
| intrinsic_dispatch | 1745 | throughput: 8595988 intrinsic calls/s |
| function_call | 666 | throughput: 9009009 calls/s |
| array_callbacks | 1157 | throughput: 8297320 callbacks/s |
| record_update | 436 | throughput: 2293577 updates/s |
| unicode_char_at | 1298 | throughput: 2311248 chars/s |
| task_spawn_wait | 572 | throughput: 174825 tasks/s |
| tui_headless | 4127 | throughput: 121 frames/s |
| notes_headless | 8776 | throughput: 28 frames/s |
