...
| [Generics Extensions](generics.md) | Constraints, HKT, variance, specialization |
| ~~[Error Handling Extensions](error-handling.md)~~ | ~~Chaining combinators~~ — **implemented** (`Map`, `AndThen`, `OrElse`) |
| [Parallel VM Execution](parallel-vm.md) | Automatic multi-core `go` tasks via thread pool and work-stealing |
