...
| [Stdlib Extensions](stdlib-extensions.md) | String padding/repeat, timer events, `for-in` over dict, index access — **partially implemented** (`Dict.Map`/`Filter`, `String S[I]`, `Console.ReadEventTimeout`/`PollEvent`) |
