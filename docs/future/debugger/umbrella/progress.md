...
- Last completed item: `U80-21` after `U80-20`
- Next child: `U80-30` after `U80-21`
- Checkpoint: recoverable in-memory capture of all-stop and queued input
  without replay; `UMB-80` package remains active
...
| `UMB-80` | active | Capture at all-stop and queued input; replay stays rejected; see [umb-80/progress.md](umb-80/progress.md) |
