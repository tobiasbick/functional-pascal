...
| `V30-14` | Current docs describe implemented behavior and limitations only | Documentation review | pass through U30-30 |
| `V30-15` | No FPAS syntax, semantic, or language-spec change | Diff review | pass through U30-30 |
| `V30-16` | Formatting, locked workspace build/tests, changed-library Clippy, extension tests, and diff check pass | Commands recorded in progress | pass through U30-30 focused gates; full U30-60 pending |
