...
- [x] Add a Mandelbrot `Std.Graph` example program or port the existing showcase.
...
- [x] headless compiler smoke coverage for the Mandelbrot explorer example
...
- [x] a Mandelbrot example runs interactively
