...
| 6 — Production-readiness gate | [Phase 6](phases/phase-6-readiness.md) | Complete; legacy IDE excluded. |
| 7 — Promote to `Std.Tui` | [Phase 7](phases/phase-7-promotion.md) | Task 7.1 is ready. |
