...
Lexical and expression fundamentals: types, bindings, literals, operators, and comments.

Formal syntax: [`grammar.ebnf`](../../../specs/grammar.ebnf) (Part 1 — lexical grammar; Part 2 — expressions).
