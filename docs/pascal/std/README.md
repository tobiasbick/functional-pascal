...
- `Std.Task` - [task.md](task.md) (`Wait`, `WaitAll` — blocking on `task` handles from `go`; language rules in [08-concurrency.md](../08-concurrency.md); VM layout in [parallel-vm.md](../../future/parallel-vm.md))
