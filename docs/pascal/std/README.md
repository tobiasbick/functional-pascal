...
- `Std.Tui` dispatch mode (target) - [tui-app.md](tui-app.md) (`Application.Host*` → VM intrinsics **255**–**262**; **`Application.Run`** / handler bundle **not** in Pascal yet. See [tui-application-framework.md](../../future/tui-application-framework.md).)
