...
| Owned dialog modal | `fpas examples/pascal/tui/show_dialog.fpas` | The dialog opens as an owned modal root, modal-local Escape closes it, and closing unregisters the owned root view. |
