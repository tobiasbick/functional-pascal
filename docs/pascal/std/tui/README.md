...
| --- | --- |
| Turbo Vision | `examples/pascal/tui/turbo_vision_dialog.fpas`, `apps/ide` (menu, custom About dialog, shared live session) |
...
| [VM bridge](app/vm-bridge.md) | Pascal-to-intrinsic map and contributor architecture |
