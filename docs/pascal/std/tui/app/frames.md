...
| Intrinsics **410..=422**, **428..=429** | `crates/fpas-bytecode/src/intrinsic/tui/mod.rs` |
| FPAS tests | `tests/tui/frames/tui_frame_chrome_test.fpas`, `tests/tui/frames/tui_frame_chrome_actions_test.fpas`, `tests/tui/modals/tui_framed_dialog_test.fpas`, `tests/tui/frames/tui_frame_window_test.fpas`, `tests/tui/frames/tui_frame_layout_test.fpas`, `tests/tui/frames/tui_frame_scroll_test.fpas`, `tests/tui/frames/tui_frame_window_list_test.fpas`, `tests/tui/frames/tui_frame_reserved_commands_test.fpas`, `tests/tui/frames/tui_frame_occlusion_move_test.fpas`, `tests/tui/frames/tui_frame_occlusion_zoom_test.fpas`, `tests/tui/frames/tui_frame_occlusion_resize_test.fpas` |
