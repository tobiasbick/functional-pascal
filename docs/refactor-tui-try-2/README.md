...
- Agent upstream watch: [`AGENTS.md`](../../AGENTS.md#upstream-watch--turbo-vision-4-rust-read-back-stream-a)
- Contributor entry point: [`AI_CONTRIBUTING.md`](../../AI_CONTRIBUTING.md#good-entry-points)
