...
| `Bridged*` adapter views | 7 (`bridged_button`, `bridged_check_box`, `bridged_list_box`, `bridged_outline`, `bridged_radio_button`, `bridged_static_text`, `bridged_memo`, `bridged_text_viewer`) |
