...
REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("docs/pascal/std/tui-app.md", "docs/pascal/std/tui/app.md"),
    ...
    ("docs/pascal/std/str.md", "docs/pascal/std/text/str.md"),
